...
export MYSQL_CXX_CNT=/home/zollino/mysqlcppInstallation_8_0_dynamic/mysql-connector-cpp-install/
...
export LD_LIBRARY_PATH=/home/zollino/mysqlcppInstallation_8_0_dynamic/mysql-connector-cpp-install/lib64/debug:$LD_LIBRARY_PATH
