...
export MYSQL_CXX_CNT=/home/zollino/mysqlcppInstallationTest/mysql-connector-cpp-install
...
export LD_LIBRARY_PATH=/home/zollino/mysqlcppInstallationTest/mysql-connector-cpp-install/lib64:$LD_LIBRARY_PATH
